...
# Generated by FastChannels' "Export ah4c scripts" button. FASTCHANNELS_URL is
# read from ah4c's own environment, falling back to the URL confirmed at export
# time when the environment variable is unset or empty.
#
...
STATION="$1"
TUNERIP="$2"
FASTCHANNELS_URL="${FASTCHANNELS_URL:-__FASTCHANNELS_URL__}"
