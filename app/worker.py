...
def seed_sources():
    with flask_app.app_context():
        ...
        default_disabled_sources = {'amazon_prime_free', 'aenetworks_tve', 'fox_tve', 'cox', 'cspan', 'sling', 'localnow', 'pluto', 'frndlytv', 'fubo', 'hdhomerun', 'freecast', 'vidaa', 'distro', 'philo', 'directv'}
